...
实际上有四种标准的 Unicode 形式。最常见的是 NFC。一个字符串可以通过`norm.NFC.String(str)`转换成 NFC 形式。下面这个名为`norm.go`的程序以两种方式形成![A436770_1_En_6_Figb_HTML.gif](A436770_1_En_6_Figb_HTML.gif)的字符串，一种是单个字符，另一种是组合字符，并打印字符串、它们的字节，然后是规范化形式及其字节。
...
`Single char`![A436770_1_En_6_Figa_HTML.gif](A436770_1_En_6_Figa_HTML.gif)`bytes`T2】

`Composed char`![A436770_1_En_6_Figa_HTML.gif](A436770_1_En_6_Figa_HTML.gif)`bytes`T2】

`Normalized char`![A436770_1_En_6_Figa_HTML.gif](A436770_1_En_6_Figa_HTML.gif)`bytes`T2】
