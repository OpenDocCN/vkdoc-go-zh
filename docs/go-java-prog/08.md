...
[`https://en.wikipedia.org/wiki/Structured_programming`；](https://en.wikipedia.org/wiki/Structured_programming) [` en。维基百科。org/wiki/Structured _ program _ theory`](https://en.wikipedia.org/wiki/Structured_program_theorem)
