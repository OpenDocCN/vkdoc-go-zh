...
![A337881_1_En_8_Fig1_HTML.jpg](A337881_1_En_8_Fig1_HTML.jpg)
...
![A337881_1_En_8_Fig2_HTML.jpg](A337881_1_En_8_Fig2_HTML.jpg)
...
![A337881_1_En_8_Fig3_HTML.jpg](A337881_1_En_8_Fig3_HTML.jpg)

图 8-3。

Directory structure of the HTTP API application

包`controllers`由处理函数和测试组成。包`model`定义了应用程序的数据模型。它还为持久性存储定义了一个接口，以便您可以为应用程序代码和测试使用不同的接口实现。包`store`通过实现包`model.`中定义的接口来提供持久存储的具体实现
